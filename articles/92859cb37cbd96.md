...
``rebase``や``fast-forword``しようとしていたユーザがデフォルトの``merge``が実行されてしまうことで、不要なコミットが作られてしまうことがあるためのようです。

## おわりに
お読みくださり、ありがとうございます！
長らく放置してしまっていたWarningの理解をやっと進めることができました！
何となく、ふわっとわかっていたつもりになっていましたが、今回、しっかりと学習することができました。
それでもまだ曖昧な部分があるかもしれないです。記事の内容に不備などございましたら、コメントでご教示頂けますと嬉しいです。
