...
しかし、お仕事をしていて、この事象に遭遇した方に、上手く説明することができませんでした。
それがきっかけで、そのWarningについて、いい加減一度ちゃんと向き合わなければ...！と思いました。
...
hint: You have divergent branches and need to specify how to reconcile them.
```
ざっくり意訳ですが、「不一致なブランチがあるので、それらを調整する方法を指定する必要がある」と言われているのかなと想定できます。
